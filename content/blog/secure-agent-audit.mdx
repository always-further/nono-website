...
date: "2026-04-22"
description: "How nono records every action an AI agent makes in an append-only Merkle tree the agent itself cannot reach, and lets anyone verify after the fact — with cryptographic proof — that the record was not forged, edited, or truncated."
author: "Luke Hinds"
