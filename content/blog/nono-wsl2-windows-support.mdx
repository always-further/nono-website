...
If native Windows sandboxing matters to you, follow the project on [GitHub](https://github.com/always-further/nono) or join the [Discord](https://discord.gg/pPcjYzGvbS) — we'll share progress there as it develops.
