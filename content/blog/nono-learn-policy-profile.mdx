---
title: "Sandboxing AI Agents with nono: From Discovery to Production Profiles"
date: "2026-03-17"
description: "Learn how to use nono's built-in profiles to sandbox AI agents like Claude Code. We cover the discovery process, customizing profiles, and best practices for production deployments."
author: "Luke Hinds"
...
============================================================
 ...
 i 42 paths already covered by system defaults
```
