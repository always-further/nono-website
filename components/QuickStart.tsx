  ...
  return (
    <section id="quick-start" className="py-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-terminal-bg rounded-xl overflow-hidden">
          {/* Tabs */}
            ...
            {codeExamples.map((example, index) => (
              <button
                ...
                className={`px-5 py-3 text-sm font-medium transition-colors border-b-2 ${
                  activeTab === index
                    ? "text-terminal-text border-accent"
                    : "text-terminal-text/50 hover:text-terminal-text border-transparent"
                }`}
              >
                {example.label}
              </button>
          ...
          <div className="relative">
            <pre className="p-6 text-terminal-text font-mono text-sm overflow-x-auto">
            ...
            <button
              ...
              className="absolute top-4 right-4 p-2 rounded-lg bg-terminal-bg hover:bg-terminal-text/10 text-terminal-text/40 hover:text-terminal-text transition-colors"
