  ...
  return (
    <Tag
      className={cn(
        ...
        hoverable && "transition-all duration-300 hover:bg-[rgba(255,255,255,0.05)] hover:border-[rgba(255,255,255,0.14)] hover:shadow-[0_0_50px_rgba(255,255,255,0.06),inset_0_1px_0_rgba(255,255,255,0.06)]",
        className,
      )}
    >
